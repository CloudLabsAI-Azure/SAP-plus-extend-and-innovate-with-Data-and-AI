...
1. On the Power BI report, expand the **Transform data (1)** item on the Home tab toolbar menu. Select **Transform data (2)**.
...
4. In the Power Query Editor, with the **SalesOrderPayments (1)** table selected in the Queries pane, scroll all the way to the right of the displayed table. Right-click the **AzureML.predict-incoming-cashflow-svc (2)** field menu and choose to **rename (3)** the field `predOffset`.
...
8. Right-click the new **predPaymentDate (1)** and expand the **Change Type (2)** option and choose **Date (3)**.
