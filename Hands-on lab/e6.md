...
In this exercise, you successfully retrieved the access key for the Azure Data Lake Storage account, created an Azure Machine Learning datastore to facilitate data access, and configured and executed an Automated Machine Learning job. To complete the process, you deployed the best-performing model from the Automated ML job as a web service, making it ready for real-time predictions.

## Objectives

After completing this lab, you will be able to:

- Create the SalesPaymentsFull Spark table from the parquet file
- Create an Azure Machine Learning linked service
- Train a new regression model for incoming cash flow
- Deploy and test the regression model in the dedicated SQL pool
