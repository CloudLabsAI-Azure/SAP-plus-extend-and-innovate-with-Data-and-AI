...
3. Fill in the New linked service form as follows, then test the connection. Select **Test connection**, once it states that the connection is successful, select **Create**.
