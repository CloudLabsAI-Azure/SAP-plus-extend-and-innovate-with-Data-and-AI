...
In this exercise, we will implement a series of visualizations to provide Contoso Retail with deep insights into their historical sales orders and payment data. By leveraging advanced analytics, we aim to reveal key trends, patterns, and anomalies, enabling more informed decision-making and strategic planning.

## Objectives

After completing this lab, you will be able to:

- Retrieve the database connection information for the dedicated SQL pool
- Import data into Power BI
- Create the relational model
- Create a sales per data and customer group visualization
- Create a sales per region and customer group visualization
- Create a payments per date and customer group visualization
- Create a sales per customer group and material group visualization
- Create a payment offset per customer group visualization
...
1. Open **Power BI Desktop**. Select **Sign in**. Enter the email address: <inject key="AzureAdUserEmail"></inject>, select **Continue**. Enter the password: <inject key="AzureAdUserPassword"></inject>. On the splash screen, select the **Get Data** > **Get Data to get started**.
